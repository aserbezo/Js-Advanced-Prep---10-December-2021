...
describe("companyAdministration", ()=>{
    describe('hiringEmployee',() => {
        it('test 1', () => {
            expect( () => companyAdministration.hiringEmployee("Alex","Engineer",1))
            .to.throw('We are not looking for workers for this position')
            expect(companyAdministration.hiringEmployee("Alex","Programmer",3))
            .to.equal(`Alex was successfully hired for the position Programmer.`)
            expect(companyAdministration.hiringEmployee("Alex","Programmer",5))
            .to.equal(`Alex was successfully hired for the position Programmer.`)
            expect(companyAdministration.hiringEmployee("Alex","Programmer",2))
